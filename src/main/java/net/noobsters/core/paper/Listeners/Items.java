...
public class Items implements Listener{
    ...
    Items(PERMADED instance){
        ...
        SmithingRecipe recipe = new SmithingRecipe(new NamespacedKey(instance, "test"), 
    ...
    public void onCustomArmor(PrepareSmithingEvent e){
        ...
        if(armor == null || upgrade == null) return;

        if(upgrade.getItemMeta().hasCustomModelData() && upgrade.getItemMeta().getCustomModelData() == 143){
            //blood armor
        ...
        }else if(upgrade.getItemMeta().hasCustomModelData() && upgrade.getItemMeta().getCustomModelData() == 142){
    ...
    public ItemStack addBloodHelmetMeta(ItemStack armor){
        ...
        final AttributeModifier toughness = new AttributeModifier(UUID.randomUUID(),
                "GENERIC.ARMOR_TOUGHNESS", 3.0, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlot.HEAD);
    ...
    public ItemStack addBloodChestPlateMeta(ItemStack armor){
        ...
        bloodMeta.addAttributeModifier(Attribute.GENERIC_ARMOR, armorRes);
        final AttributeModifier toughness = new AttributeModifier(UUID.randomUUID(),
                "GENERIC.ARMOR_TOUGHNESS", 3.0, AttributeModifier.Operation.ADD_NUMBER,
                EquipmentSlot.CHEST);
        bloodMeta.addAttributeModifier(Attribute.GENERIC_ARMOR_TOUGHNESS, toughness);
        final AttributeModifier health = new AttributeModifier(UUID.randomUUID(), "GENERIC.MAX_HEALTH", 5.0,
                AttributeModifier.Operation.ADD_NUMBER, EquipmentSlot.CHEST);
    ...
    public ItemStack addBloodLeggingsMeta(ItemStack armor){
        ...
        bloodMeta.addAttributeModifier(Attribute.GENERIC_ARMOR, armorRes);
        final AttributeModifier toughness = new AttributeModifier(UUID.randomUUID(),
                "GENERIC.ARMOR_TOUGHNESS", 3.0, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlot.LEGS);
        bloodMeta.addAttributeModifier(Attribute.GENERIC_ARMOR_TOUGHNESS, toughness);
        final AttributeModifier health = new AttributeModifier(UUID.randomUUID(), "GENERIC.MAX_HEALTH", 5.0,
                AttributeModifier.Operation.ADD_NUMBER, EquipmentSlot.LEGS);
        bloodMeta.addAttributeModifier(Attribute.GENERIC_MAX_HEALTH, health);
    ...
    public ItemStack addBloodBootsMeta(ItemStack armor){
        ...
        bloodMeta.addAttributeModifier(Attribute.GENERIC_ARMOR, armorRes);
        final AttributeModifier toughness = new AttributeModifier(UUID.randomUUID(),
                "GENERIC.ARMOR_TOUGHNESS", 3.0, AttributeModifier.Operation.ADD_NUMBER, EquipmentSlot.FEET);
        bloodMeta.addAttributeModifier(Attribute.GENERIC_ARMOR_TOUGHNESS, toughness);
        final AttributeModifier health = new AttributeModifier(UUID.randomUUID(), "GENERIC.MAX_HEALTH", 5.0,
                AttributeModifier.Operation.ADD_NUMBER, EquipmentSlot.FEET);
        bloodMeta.addAttributeModifier(Attribute.GENERIC_MAX_HEALTH, health);
    ...
    public void onItemConsume(PlayerItemConsumeEvent e) {
        ...
        if(item == Material.MILK_BUCKET && itemMeta.hasDisplayName() && itemMeta.getDisplayName().toString().contains("Magic")){
    ...
    public void impact(ProjectileHitEvent e){
        ...
        if(projectile instanceof Arrow && projectile.getCustomName() != null && projectile.getCustomName().toString().contains("explosive")){
    ...
    public void onShoot(EntityShootBowEvent e){
        ...
        if(!bow.hasCustomModelData()) return;
        ...
        if((bow.getCustomModelData() == 105 || bow.getCustomModelData() == 112)){
            ...
            Bukkit.dispatchCommand(Bukkit.getConsoleSender(), "playsound minecraft:magic_1 ambient @a "
